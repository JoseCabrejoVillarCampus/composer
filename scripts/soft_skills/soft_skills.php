...
class soft_skills extends connect
{
    ...
    private $queryGetAll = 'SELECT soft_skills.*, team_schedule_software_skiils.team_name AS team_schedule_team_name, journey.name AS journey_name, trainers.id AS trainers_id, locations.name_location AS location_name, subjects.name_subject AS subject_name 
    FROM soft_skills 
    INNER JOIN team_schedules ON soft_skills.id_team_schedule = team_schedules.id 
    INNER JOIN journey ON soft_skills.id_journey = journey.id 
    INNER JOIN trainers ON soft_skills.id_trainer = trainers.id 
    INNER JOIN locations ON soft_skills.id_location = locations.id 
    INNER JOIN subjects ON soft_skills.id_subject = subjects.id';
